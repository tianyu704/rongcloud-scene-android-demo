...
public class RadioRoomProvider extends AbsProvider<VoiceRoomBean> implements IListProvider<VoiceRoomBean> {
    ...
    private final static RadioRoomProvider _provider = new RadioRoomProvider();
    private List<String> bgImages = new ArrayList<>();

    private RadioRoomProvider() {
        super(-1);
    }

    public static RadioRoomProvider provider() {
        return _provider;
    }
